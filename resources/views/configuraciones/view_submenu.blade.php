...
<div id="myModal" class="hs-overlay hidden ti-modal mymodal">
                ...
                <form id="frm_">
                    ...
                    <div class="grid grid-cols-12 sm:gap-x-6 sm:gap-y-4">
                        ...
                        <div class="md:col-span-6 col-span-12 mb-4">
                            ...
                            <input type="text" class="form-control" id="nombre_controlador" name="controlador" placeholder="Controlador" aria-label="Controlador">
                        </div>
                        <div class="md:col-span-6 col-span-12 mb-4">
                        ...
                        <div class="md:col-span-6 col-span-12 mb-4">
                            ...
                            <input type="text" class="form-control text-right" id="orden" name="orden" placeholder="Orden" aria-label="Orden">
                        </div>
...
<div id="myModalIcon" class="hs-overlay hidden ti-modal mymodal">
    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
        <div class="ti-modal-content">
            <div class="ti-modal-header">
                <h6 class="ti-modal-title">
...
@include('utilidades.view_modal_status')
@include('utilidades.view_modal_error')
@include('utilidades.view_modal_info')
@include('utilidades.view_modal_question')
@include('utilidades.view_modal_success')
@include('utilidades.view_modal_warning')