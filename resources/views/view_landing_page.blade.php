...
<body class="landing-body">
    ...
    <div class="landing-page-wrapper relative">
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element !items-center">
                        ...
                        <div class="lg:hidden block">
                            <a href="/login" class="ti-btn ti-btn-primary !m-0">
                                Sign In
                            </a>
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        <div class="landing-logo-container my-auto hidden lg:block">
                            <div class="responsive-logo">
                                <a class="responsive-logo-light" href="/index" aria-label="Brand"><img src="/build/assets/images/brand-logos/desktop-logo.png" alt="logo" class="mx-auto"></a>
                                <a class="responsive-logo-dark" href="/index" aria-label="Brand"><img src="/build/assets/images/brand-logos/desktop-white.png" alt="logo" class="mx-auto"></a>
                            </div>
                        </div>
                        <div class="slide-left hidden" id="slide-left"><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <div class="slide-right hidden" id="slide-right"><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24">
                                <path d="M10.707 17.707 16.414 12l-5.707-5.707-1.414 1.414L13.586 12l-4.293 4.293z"></path>
                            </svg></div>
                        <div class="lg:flex hidden space-x-2 rtl:space-x-reverse">
                            <a href="/login" class="ti-btn w-[6.375rem] ti-btn-primary-full m-0 p-2">Sign In</a>
        ...
        <div class="main-content !p-0 landing-main dark:text-defaulttextcolor/70">
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            <div class="xxl:col-span-7 xl:col-span-7 lg:col-span-7 col-span-12">
                                <div class="lg:py-[3rem]">
                                    ...
                                    <a href="/index" class="m-1 ti-btn ti-btn-primary-full">
                                        View Demos
                    ...
                    <div class="grid grid-cols-8 justify-center align-center">
                        <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 col-span-12 customize-image text-center">
                            <div class="lg:text-start !flex items-center lg:justify-start justify-center">
                                <img src="/build/assets/images/media/landing/3.png" alt="" class="img-fluid">
                            </div>
                        </div>
                            ...
                            <div class="">
                                <div class="feature-logos sm:mt-[3rem] flex-wrap">
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="/build/assets/images/media/landing/web/1.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-white text-[1.25rem]">Laravel</h5>
                                    </div>
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="/build/assets/images/media/landing/web/2.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-white text-[1.25rem]">Vite</h5>
                                    </div>
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="/build/assets/images/media/landing/web/3.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-white text-[1.25rem]">Tailwind Css</h5>
                                    </div>
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="/build/assets/images/media/landing/web/4.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-white text-[1.25rem]">HTML5</h5>
                                    </div>
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="/build/assets/images/media/landing/web/5.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-white text-[1.25rem]">Sass</h5>
                                    </div>
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="/build/assets/images/media/landing/web/6.png" alt="image" class="featur-icon">
                            ...
                            <div class="swiper-slide rtl:dir-rtl">
                                <div class="box testimonial-card">
                                    <div class="box-body">
                                        <div class="flex items-center mb-4">
                                            <span class="avatar avatar-md avatar-rounded me-4">
                                                <img src="/build/assets/images/faces/16.jpg" alt="">
                                            </span>
                                            <div>
                        ...
                        <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                            <div class="box text-center team-card ">
                                <div class="box-body p-[3rem]">
                                    ...
                                    <div class="mt-2">
                                        <a href="/profile" class="ti-btn ti-btn-light !font-medium" target="_blank">View profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box overflow-hidden shadow-none justify-center">
                        <div class="box-body !p-0">
                            <div class="tab-content dark:!border-defaultborder/10" id="myTabContent">
                                <div class="tab-pane show active !p-0 dark:!border-defaultborder/10" id="pricing-monthly-pane" aria-labelledby="pm-item" role="tabpanel" tabindex="0">
                                    <div class="grid grid-cols-12 justify-center">
                                ...
                                <div class="tab-pane !p-0 border dark:border-defaultborder/10 hidden" id="pricing-yearly-pane" aria-labelledby="py-item" role="tabpanel" tabindex="0">
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                <div class="xl:col-span-6 col-span-12">
                                    <div class="accordion accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ1">
                                        <div class="hs-accordion-group">
                                            <div class="hs-accordion active bg-white dark:bg-bodybg  border dark:border-defaultborder/10 mt-[0.5rem] rounded-sm  dark:border dark:border-defaultborder/10-white/10" id="faq-one">
                                            ...
                                            <div class="hs-accordion bg-white dark:bg-bodybg border dark:border-defaultborder/10 mt-[0.5rem] rounded-sm dark:border-defaultborder/10-white/10" id="faq-thirty">
                                                ...
                                                <div id="faq-collapse-four" class="hs-accordion-content w-full overflow-hidden hidden transition-[height] duration-300" aria-labelledby="faq-thirty">
                                                    <div class="p-5">
                                                        <p class="text-defaulttextcolor dark:text-defaulttextcolor/70 ">
                                                            <strong>This is the first item's accordion body.</strong> It is shown by
                                                            default, until the collapse plugin adds the appropriate classes that we
                                ...
                                <div class="xl:col-span-6 col-span-12">
                                    <div class="accordion accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ2">
                                        <div class="hs-accordion-group">
                                            <div class="hs-accordion active bg-white dark:bg-bodybg border dark:border-defaultborder/10 mt-[0.5rem] rounded-sm dark:border dark:border-defaultborder/10-white/10" id="faq-five">
                ...
                <div class="container">
                    <div class="grid grid-cols-12 gap-6">
                        <div class="xl:col-span-4 col-span-12">
                            <div class="px-6">
                                <p class="font-semibold mb-4"><a aria-label="anchor" href="/index"><img src="/build/assets/images/brand-logos/desktop-dark.png" alt=""></a></p>
            ...
            <div class="text-center landing-main-footer py-4 opacity-[0.87]">
                <span class="text-[#8c9097] dark:text-white/50 text-[0.9375rem]"> Copyright © <span id="year"></span> <a href="javascript:void(0);" class="!text-primary font-semibold"><u>ynex</u></a>.
    ...
    <!-- DEFAULTMENU JS -->
    <link rel="modulepreload" href="/build/assets/defaultmenu-a517708d.js" />
    <script type="module" src="/build/assets/defaultmenu-a517708d.js"></script>

    <!-- SIMPLEBAR JS -->
    <script src="/build/assets/libs/simplebar/simplebar.min.js"></script>

    <!-- INTERNAL LANDING JS -->
    <link rel="modulepreload" href="/build/assets/landing-bcacd1ce.js" />
    <script type="module" src="/build/assets/landing-bcacd1ce.js"></script>
    <!-- PRELINE JS -->
