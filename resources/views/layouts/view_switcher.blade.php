            ...
            <div class=" sidemenu-layout-styles">
                ...
                <div class="grid grid-cols-2 gap-2 switcher-style">
                    <div class="flex">
                        ...
                        <label for="switcher-default-menu" class="text-defaultsize text-defaulttextcolor dark:text-defaulttextcolor/70 ms-2  font-semibold ">Default
                            Menu</label>
                    </div>
                    <div class="flex">
            ...
            <div>
                ...
                <div class="grid grid-cols-3 switcher-style">
                    ...
                    <div class="flex">
                        ...
                        <label for="switcher-header-scroll" class="text-defaultsize text-defaulttextcolor dark:text-defaulttextcolor/70 ms-2  font-semibold">Scrollable
                        </label>
                    </div>
                </div>
            </div>
            <div class="">
                ...
                <div class="grid grid-cols-3 switcher-style">
                    ...
                    <div class="flex">
                        ...
                        <label for="switcher-loader-disable" class="text-defaultsize text-defaulttextcolor dark:text-defaulttextcolor/70 ms-2  font-semibold">Disable
                        </label>
                    </div>
                </div>
            </div>
